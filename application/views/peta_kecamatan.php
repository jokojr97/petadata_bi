      ...
      <div class="container-fluid p-4" style="background-color: red">
        <div class="container">
          <div class="row">
            <div class="col-7">
              <h3 class="text-white pt-2">Peta Data Kecamatan</h3>
            </div>
            <div class="col-4">              
