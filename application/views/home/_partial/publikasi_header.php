  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="<?= base_url() ?>home/" class="scrollto"><img src="<?= base_url() ?>assets/home/img/logoo.png" alt="" title=""></a>
      </div>
        ...
        <ul class="nav-menu">
          ...
          <li<?php if ($menu == "tentangKami") { echo " class=\"menu-active\""; } ?>><a href="<?= base_url() ?>home/#ttgAplikasi"><i class="fa fa-info-circle"></i> Tentang Aplikasi</a></li>
          <li<?php if ($menu == "hubungiKami") { echo " class=\"menu-active\""; } ?>><a href="<?= base_url() ?>home/#subscribe"><i class="fa fa-phone"></i> Hubungi Kami</a></li>
